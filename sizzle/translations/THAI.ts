export const THAI_CONTENT ={
    ...
    "cha2_c3": "其实，图像标注已经是reCAPTCHA为我们安排的第二个任务了。在它的V1阶段，从2007-2018，我们通过在真人验证时输入单词，帮助计算机完成了人类1.3亿册书籍中超过1/5内容的线上录入。而人类书籍，正是GPT系列模型中重要的数据来源。",
    "cha2_p1": "reCAPTCHA正要求用户标出图中所有的道路标志",
    "cha2_p2": "GPT-3数据来源：WebText2是一个由Reddit高分帖子中引用的链接组成的数据集",
    "cha2_c4": "根据OpenAI的官方论文，除了书籍，GPT的训练数据中还有3%来自维基百科，22%源于Reddit。如果你也曾在reCAPTCHA上填写过验证码、在Wikipedia上审阅过词条、在Reddit发布过帖子，你会为自己对技术浪潮的贡献感到骄傲吗？说实话，我会。但与此同时，当ChatGPT Plus向我收取每月20$的升级费用，当我面对OpenAI要实现 2万亿营收的豪言壮语，我仿佛又想起了Facebook、Twitter和TikTok们尚未完结的故事，又看到了财富创造者一无所获的身影。",
